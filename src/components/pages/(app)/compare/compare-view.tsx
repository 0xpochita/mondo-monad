...
const MONDO_LOGO = "/Assets/Images/Logo-Brand/mondo-transparent.png";
import {
  formatApy,
  formatTimelock,
  formatTvl,
      ...
      <main className="mx-auto flex w-full max-w-310 flex-1 flex-col gap-6 px-4 py-8 sm:px-6 sm:py-10 mb-15">
        <header className="flex flex-col gap-2">
          ...
          <p className="max-w-2xl text-sm text-muted">
            ...
            <span className="font-semibold text-main">LI.FI Earn</span> and see
    ...
    >
      ...
      <div className="flex max-w-md flex-col gap-2">
        ...
        <p className="text-sm text-muted">
          Add up to {COMPARE_MAX_SLOTS} vaults from any protocol on Monad,
      ...
      <div className="mt-2 flex flex-wrap items-center justify-center gap-1.5 text-[11px] text-faint">
        ...
        <Image
          ...
          width={12}
          height={12}
          className="h-3 w-3 invert opacity-80"
        />
        <span className="font-semibold text-muted">LI.FI Earn</span>
      </div>
    </motion.div>
  );
}
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-1.5 text-[11px] text-faint">
      ...
      <Image
        ...
        className="h-3 w-3 invert opacity-80"
      />
      <span className="font-semibold text-muted">LI.FI Earn API</span>
      <span>·</span>
