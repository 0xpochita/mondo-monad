...
const MONAD_CHAIN = {
  name: "Monad",
  logo: "/Assets/Images/Logo-Coin/monad-logo.jpg",
} as const;
...
export function IdleAggregatorCard() {
  return (
    <FeatureSections
      eyebrow="Mondo Aggregator · Monad-first"
      eyebrowIcon={
        <Image
      ...
      title="Best yield on Monad, aggregated live."
      description={
        <>
          ...
          <span className="inline-flex items-baseline gap-1 align-baseline">
            <Image
              ...
              width={12}
              height={12}
              className="inline-block h-3 w-3 translate-y-[2px] rounded-full object-cover"
            />
            <span className="font-semibold text-main">Monad</span>
          </span>{" "}
